...
var SerienTabContainerLinks = [];
var SerienTabContainerRechts = [];

// - - - - - - - - - - - - - - - - - - - - - - - - - - 
// Config
// - - - - - - - - - - - - - - - - - - - - - - - - - - 

// Das Initialisieren eines Serien Tabs
var SerienTab_Name1 = new SerienTab("Name1", []); 
var SerienTab_Name2 = new SerienTab("Name2", []); 
// Drauf zugreifen auf den Tab (SerienTab_Name1) und auf dessen serien (.serien) mit push hinzufügen
SerienTab_Name1.serien.push(["Agents-of-S-H-I-E-L-D", "Agents-of-S-H-I-E-L-D"]); 
SerienTab_Name2.serien.push(["Gotham", "Gotham"]);

// Hinzufügen des SerienTabs zu einer Seite
SerienTabContainerLinks.push(SerienTab_Name1);
SerienTabContainerRechts.push(SerienTab_Name2);
